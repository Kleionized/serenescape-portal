                  ...
                  <div className="grid grid-cols-1 gap-3">
                    {stressors.map((stressor) => (
                      <button
                        ...
                        className="p-4 text-left rounded-xl bg-white/40 hover:bg-white/70 transition-all dark:bg-gray-800/30 dark:hover:bg-gray-800/50"
                      >
                ...
                <div className="space-y-3">
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 p-4 rounded-xl bg-white/60 focus:outline-none focus:ring-2 focus:ring-safespace-primary/40 dark:bg-gray-800/30 dark:focus:ring-safespace-primary/60 dark:text-white dark:placeholder-gray-400"
                    />
                    <button
              ...
              <div className="space-y-10">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[180px] p-6 rounded-2xl bg-transparent focus:outline-none focus:ring-2 focus:ring-safespace-primary/40 resize-none dark:text-white dark:placeholder-gray-400 dark:focus:ring-safespace-primary/60"
                  />
                </div>
