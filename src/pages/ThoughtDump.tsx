    ...
    <div className="min-h-screen bg-gradient-to-b from-safespace-background to-safespace-muted/30 pt-20">
      <div className="max-w-6xl mx-auto px-6 pb-20">
        <header className="mb-12">
          <h1 className="heading-lg text-safespace-foreground mb-3 text-center">Thought Dump</h1>
          <p className="text-gray-500 text-lg text-center max-w-2xl mx-auto">A private space to freely express your thoughts and feelings</p>
        </header>
        ...
        <div className="mt-6 max-w-2xl mx-auto p-6 bg-white/40 backdrop-blur-sm rounded-2xl shadow-sm dark:bg-gray-800/20">
          <h2 className="heading-sm mb-4 text-center">Why Use a Thought Dump?</h2>
