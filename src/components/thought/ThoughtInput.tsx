      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <textarea
            ...
            className="w-full min-h-[200px] p-4 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-safespace-primary resize-y"
          />
        </div>
        ...
        {isSaved && (
          <div className="mt-4 bg-green-50 text-green-700 px-4 py-3 rounded-md flex items-center gap-2 animate-fade-in">
