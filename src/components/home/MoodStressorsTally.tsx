          ...
          {filteredStressors.map(stressor => (
            <div key={stressor.id} className="flex items-center justify-between group py-2">
              ...
              <div className="flex items-center gap-2">
                ...
                {!stressor.resolved && (
                  <button onClick={() => handleResolveStressor(stressor.id, stressor.name)} className="opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700" title="Mark as resolved">
