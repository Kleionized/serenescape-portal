...
const MoodStressorsTally = () => {
  ...
  return <div className="glass-card rounded-xl p-6 animate-scale-in">
      ...
      {filteredStressors.length === 0 ? <div className="text-center py-6">
          ...
          {filteredStressors.map(stressor => <div key={stressor.id} className="flex items-center justify-between group">
